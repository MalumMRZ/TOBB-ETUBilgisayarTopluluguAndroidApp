...
public class FutureActivity extends Fragment {

    Context context;
    String keyWord;


    public FutureActivity(Context context){
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                if (activitiesMap != null) {
                    ...
                    if (communityActivities.size() >0){
                        ...
                        Toast.makeText(context, "Topluluğumuzun şimdilik gelecek etkinliği yok", Toast.LENGTH_LONG).show();
                    }
                }
