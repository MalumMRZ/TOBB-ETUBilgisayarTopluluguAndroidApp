...
public class PastProject extends Fragment {
    ...
    public PastProject(Context context){
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                if (activitiesMap != null) {
                    ...
                    if (communityProjects.size() >0){
                        ...
                        Toast.makeText(context, "Topluluğumuzun henüz ortak projesi yok", Toast.LENGTH_LONG).show();
                    }
                }
